...
| 항목 | 값 |
| --- | --- |
| ISO 크기 | `3,599,241,216 bytes` |
| SHA-256 | `cdccbc3529a2e6ce640756c627e9f17f9a68ac430cec11483f9b60ffb9a33428` |
...
패치 파일 자체의 SHA-256은 `5f37e2376c9d7f45c231e750fa2b5d2ad70ee5790a763443c0a5bf5ee3f82afd` 입니다.
...
- `remaining_candidates`와의 차이 705개는 ADV 런타임 사본, SLG 내부 HEADER/STAGE 식별자, 리소스 경로·폰트명으로 확인되어 화면에 노출되는 미번역 텍스트는 없는 것으로 판정했습니다.
